...
<image src="readme/pdf1.png" alt="Пример работы middle-end части" width=60%>


_Итоговый многочлен Тейлора и график_

<image src="readme/plot.png" alt="Пример работы middle-end части" width=60%>


## Принцип работы
Для вычисления производной строится дерево, соответствующее введённой функции. Для функции  $sin ((x + 5) ^ 2)$ он выглядит так:

<image src="readme/graph_3.png" alt="Пример работы middle-end части" width=15%>
...
<image src="readme/how_to_der.png" alt="Пример работы middle-end части" width=65%>
...
<image src="readme/deriv.png" alt="Пример работы middle-end части" width=75%>
...
<image src="readme/simpl.png" alt="Пример работы middle-end части" width=65%>
<image src="readme/simpl2.png" alt="Пример работы middle-end части" width=65%>
